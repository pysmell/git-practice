...
public class CRC16 {
    ...
    public static int calcCrc16(String data, String charsetName) throws UnsupportedEncodingException {
        byte[] byteArray = data.getBytes(charsetName);
        return calcCrc16(byteArray);
    }
    ...
    public static int calcCrc16(byte[] data, int offset, int len, int preval) {
        ...
        int iIndex;
        for (int i = 0; i < len; ++i) {
            iIndex = (ucCRCLo ^ data[offset + i]) & 0x00ff;//第一个计算出来的值
    ...
    public static void main(String[] args) throws UnsupportedEncodingException {
        // 0x02 05 00 03 FF 00 7C 09, crc16=
        //int crc = CRC16.calcCrc16(new byte[]{0x02, 0x05, 0x00, 0x03, (byte) 0xff, 0x00, 0x7c, 0x09});
        String str = "123456789a123456789a";
        int crc = CRC16.calcCrc16(str, "UTF-8");
